                ...
                <div className="row gy-4">
                    ...
                    <div className="card-item">
                      <div className="row">
                        <div className="col-xl-5">
                          <div className="card-bg" style={{"background-image":"url(assets/img/constructions-1.jpg)"}} />
                        </div>
                  ...
                  <div className="col-lg-6" data-aos="fade-up" data-aos-delay={200}>
                    <div className="card-item">
                      <div className="row">
                        <div className="col-xl-5">
                          <div className="card-bg" style={{"background-image":"url(assets/img/constructions-2.jpg)"}} />
                        </div>
                        <div className="col-xl-7 d-flex align-items-center">
                          <div className="card-body">
                  ...
                  <div className="col-lg-6" data-aos="fade-up" data-aos-delay={300}>
                    <div className="card-item">
                      <div className="row">
                        <div className="col-xl-5">
                          <div className="card-bg" style={{"background-image":"url(assets/img/constructions-3.jpg)"}} />
                        </div>
                        <div className="col-xl-7 d-flex align-items-center">
                          <div className="card-body">
                  ...
                  <div className="col-lg-6" data-aos="fade-up" data-aos-delay={400}>
                    <div className="card-item">
                      <div className="row">
                        <div className="col-xl-5">
                          <div className="card-bg" style={{"background-image":"url(assets/img/constructions-4.jpg)"}} />
                        </div>
                        <div className="col-xl-7 d-flex align-items-center">
                          <div className="card-body">
            ...
            <section id="alt-services" className="alt-services">
              <div className="container" data-aos="fade-up">
                <div className="row justify-content-around gy-4">
                  <div className="col-lg-6 img-bg" style={{"background-image":"url(assets/img/alt-services.jpg)"}} data-aos="zoom-in" data-aos-delay={100} />
                    ...
                    <div className="row">
                      <div className="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                        ...
                        <ul>
                          <li><i className="bi bi-check2-all" /> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                          <li><i className="bi bi-check2-all" /> Duis aute irure dolor in reprehenderit in voluptate velit.</li>
                          <li><i className="bi bi-check2-all" /> Provident mollitia neque rerum asperiores dolores quos qui a. Ipsum neque dolor voluptate nisi sed.</li>
                          <li><i className="bi bi-check2-all" /> Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore eu fugiat nulla pariatur.</li>
                        </ul>
                      </div>
